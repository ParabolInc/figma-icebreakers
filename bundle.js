...
define("index", ["require", "exports", "api"], function (require, exports, api_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const { widget } = figma;
    ...
    function Widget() {
        const [icebreaker, setIcebreaker] = useSyncedState('icebreaker', () => (0, api_1.generateRandomIcebreaker)((0, api_1.allIcebreakers)()));
