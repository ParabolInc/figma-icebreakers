        ...
        function Widget() {
            ...
            */
            return (figma.widget.h(AutoLayout, { name: "main", effect: [
                ...
                ], fill: "#FFF", cornerRadius: 8, overflow: "visible", direction: "vertical", spacing: 8, padding: {
                    top: 0,
                    right: 0,
                    bottom: 24,
                    left: 0,
                }, width: 576 },
                figma.widget.h(AutoLayout, { name: "top", stroke: "#E0DDEC", overflow: "visible", direction: "vertical", spacing: 8, padding: {
                        vertical: 24,
                        horizontal: 0,
                ...
                figma.widget.h(AutoLayout, { name: "icebreaker", overflow: "visible", spacing: 8, padding: {
                    ...
                    figma.widget.h(Text, { fontFamily: "IBM Plex Sans", fontSize: 22, width: "fill-parent", horizontalAlignText: 'center' }, icebreaker.question)),
